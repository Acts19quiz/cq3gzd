...
#include "cmdlib.h"
#include "s_doomsound.h"// Acts 19 quiz 3.87b base demands it
#include "s_music.h"// Acts 19 quiz 3.87b base demands it
#include "s_sound.h"
#include "m_swap.h"
#include "v_text.h"
#include "gi.h"
...
void D_DoCustomAdvanceDemo ()//[GEC]
{
	...
	if(SetPage->SoundName){S_Sound (CHAN_VOICE, CHANF_UI, SetPage->SoundName.GetChars(), 1, ATTN_NORM);}// Acts 19 quiz 3.87b-mandated change (CHAN_VOICE | CHAN_UI, SetPage->SoundName.GetChars(), 1, ATTN_NORM)
